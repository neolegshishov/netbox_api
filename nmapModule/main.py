...
class Scanner:
	def __init__(self, network: None or str = None, aggressively: bool = False, mask: int = 24):
		if network is None:
	...
	def scan(self):
		return self.nmap.scan(self.network, arguments='-A' if self.aggressively else '-sn')
